...
fun TasksScreen(tasksViewModel: TasksViewModel = viewModel()) {
    ...
    val myTaskText by tasksViewModel.myTaskText.collectAsStateWithLifecycle()
...
//
//
//    // esto se realiza en el punto 7.3 del ejercicio
//    val uiState by tasksViewModel.uiState.collectAsStateWithLifecycle()
//    val myTaskText by tasksViewModel.myTaskText.collectAsStateWithLifecycle()
//    val showDialog by tasksViewModel.showDialog.observeAsState(false)
//
...
////}
//
//// esto es una actualizacion del punto 7.3
//    Box(modifier = Modifier.fillMaxSize()) {
//        AddTasksDialog(
//            show = showDialog,
//            myTaskText = myTaskText,
...
//    ) {
//        Card(
//            // pointerInput se utiliza para capturar gestos de entrada táctil,
//            // en este caso, una pulsación larga para eliminar la tarea.
//            modifier = Modifier
//                .fillMaxWidth()
//                .padding(horizontal = 16.dp, vertical = 8.dp)
//                .pointerInput(Unit) {
